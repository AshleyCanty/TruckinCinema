...
class CycledBannerSignUpCell: UICollectionViewCell {
    ...
    fileprivate func setupViews() {
        ...
        contentView.addSubviews(subviews: [bannerImage, joinButton, descriptionLabel, ribbonIconView])
        ...
        ribbonIconView.topAnchor.tc_constrain(equalTo: contentView.topAnchor, constant: Style.RibbonViewTopMargin)
        ribbonIconView.leadingAnchor.tc_constrain(equalTo: contentView.leadingAnchor, constant: Style.RibbonViewLeadingMargin)
        
        /// description constraints
        descriptionLabel.topAnchor.tc_constrain(equalTo: contentView.topAnchor, constant: Style.DescriptionTopMargin)
        ...
        descriptionLabel.trailingAnchor.tc_constrain(equalTo: contentView.trailingAnchor, constant: -Style.DescriptionTrailingMargin)
